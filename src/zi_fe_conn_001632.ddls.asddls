...
define view entity ZI_FE_CONN_001632
  as select from zfe_aconn_001632 as Connection
  association [1..1] to zi_fe_carr_001632 as _Airline on $projection.AirlineID = _Airline.AirlineID
{
